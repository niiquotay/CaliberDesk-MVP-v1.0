  ...
  return (
    <div className="min-h-screen relative flex flex-col items-center justify-start p-6 custom-scrollbar text-white">
      <div className="max-w-5xl w-full space-y-8 relative z-10 py-8 md:py-12">
        ...
        <section className="space-y-6 py-12 border-t border-white/5 relative">
           <div className="text-center space-y-2">
              <h2 className="text-2xl font-black tracking-tight uppercase">Complete <span className="text-[#F0C927]">Business Suite</span></h2>
              <p className="text-white/30 text-[9px] font-black uppercase tracking-[0.4em]">Comprehensive organizational management tools</p>
           </div>
           
           <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 lg:grid-cols-5 gap-4">
                <div className="glass rounded-3xl p-6 border-[#F0C927]/30 bg-[#F0C927]/5 shadow-xl transition-all cursor-default flex flex-col items-center text-center ring-1 ring-[#F0C927]/10">
                  <div className="w-10 h-10 rounded-2xl bg-[#F0C927] text-[#0a4179] flex items-center justify-center mb-4 shadow-xl">
                    <Briefcase size={20} />
                  </div>
                  <h3 className="text-xs font-black uppercase mb-1.5">Job Board</h3>
                  <div className="flex items-center gap-1.5 text-[#F0C927] text-[8px] font-black uppercase tracking-widest">
              ...
              <div 
                ...
                className="glass group rounded-3xl p-6 border-white/5 hover:border-[#41d599]/40 hover:bg-[#41d599]/5 transition-all duration-500 cursor-pointer flex flex-col items-center text-center"
              >
                <div className="w-10 h-10 rounded-2xl bg-white/5 border border-white/10 group-hover:bg-[#41d599] group-hover:text-[#0a4179] flex items-center justify-center mb-4 transition-all duration-500 shadow-lg">
                  <Users size={20} />
                </div>
                <h3 className="text-xs font-black uppercase mb-1.5 group-hover:text-[#41d599] transition-colors">HR Management</h3>
                <div className="flex items-center gap-1.5 text-white/20 group-hover:text-[#41d599] text-[8px] font-black uppercase tracking-widest transition-colors">
                  Launching Q3 <ChevronRight size={10} />
                </div>
              </div>

              <div 
                onClick={() => onNavigateToModule('payroll-landing')}
                className="glass group rounded-3xl p-6 border-white/5 hover:border-blue-400/40 hover:bg-blue-400/5 transition-all duration-500 cursor-pointer flex flex-col items-center text-center"
              >
                <div className="w-10 h-10 rounded-2xl bg-white/5 border border-white/10 group-hover:bg-blue-400 group-hover:text-[#0a4179] flex items-center justify-center mb-4 transition-all duration-500 shadow-lg">
                  <Landmark size={20} />
                </div>
                <h3 className="text-xs font-black uppercase mb-1.5 group-hover:text-blue-400 transition-colors">Payroll Studio</h3>
                <div className="flex items-center gap-1.5 text-white/20 group-hover:text-blue-400 text-[8px] font-black uppercase tracking-widest transition-colors">
                  Launching Q4 <ChevronRight size={10} />
                </div>
              </div>

               <div 
                onClick={() => onNavigateToModule('vendor-landing')}
                className="glass group rounded-3xl p-6 border-white/5 hover:border-purple-400/40 hover:bg-purple-400/5 transition-all duration-500 cursor-pointer flex flex-col items-center text-center"
              >
                <div className="w-10 h-10 rounded-2xl bg-white/5 border border-white/10 group-hover:bg-purple-400 group-hover:text-[#0a4179] flex items-center justify-center mb-4 transition-all duration-500 shadow-lg">
                  <ShoppingCart size={20} />
                </div>
                <h3 className="text-xs font-black uppercase mb-1.5 group-hover:text-purple-400 transition-colors">Vendor Management</h3>
                <div className="flex items-center gap-1.5 text-white/20 group-hover:text-purple-400 text-[8px] font-black uppercase tracking-widest transition-colors">
                  Beta Testing <ChevronRight size={10} />
                </div>
              </div>

              <div 
                onClick={() => onNavigateToBlog()}
                className="glass group rounded-3xl p-6 border-white/5 hover:border-[#F0C927]/40 hover:bg-[#F0C927]/5 transition-all duration-500 cursor-pointer flex flex-col items-center text-center"
              >
                <div className="w-10 h-10 rounded-2xl bg-white/5 border border-white/10 group-hover:bg-[#F0C927] group-hover:text-[#0a4179] flex items-center justify-center mb-4 transition-all duration-500 shadow-lg">
                  <BookOpen size={20} />
                </div>
                <h3 className="text-xs font-black uppercase mb-1.5 group-hover:text-[#F0C927] transition-colors">Insights & Reports</h3>
                <div className="flex items-center gap-1.5 text-white/20 group-hover:text-[#F0C927] text-[8px] font-black uppercase tracking-widest transition-colors">
